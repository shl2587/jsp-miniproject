.<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8" import="member.*, minihome.*" %>
...
<c:if test="${empty login }">
   <c:redirect url="${cpath }/index.jsp"></c:redirect>
</c:if>
</head>
<body>
<c:if test="${not empty login }">
   <div class="top">
      ...
      <div class="topRight">
         ...
         <div class="path">
            <a href="${cpath }/header.jsp?idx=${minihomeDTO.idx }">${cpath }/header.jsp?idx=${minihomeDTO.idx }</a>
         </div>
      </div>
   </div>
   <div class="menuBar">
      <p><a href="${cpath }/minihome/minihome.jsp?idx=${minihomeDTO.idx }">홈</a></p>
      <p><a href="${cpath }/minihome/profile.jsp?idx=${minihomeDTO.idx }">프로필</a></p>
